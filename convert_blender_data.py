...
def load_renderings(data_dir: str, split: str) -> Dict:
...
def convert_to_nerfdata(basedir: str, newdir: str, n_down: int) -> None:
...
def main():
    ...
    parser.add_argument(
        "--object_name", help="While object you want to make multi scale", type=str, default=None
    )
