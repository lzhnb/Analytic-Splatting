...
def readNerfSyntheticInfo(
    path: str, white_background: bool, eval: str, extension: str = ".png"
) -> SceneInfo:
...
def readMultiScaleNerfSyntheticInfo(
    path: str,
    white_background: bool,
    eval: str,
    load_allres: bool = False,
) -> SceneInfo:
...
sceneLoadTypeCallbacks = {
    ...
    "MS-Blender": readMultiScaleNerfSyntheticInfo,
}
